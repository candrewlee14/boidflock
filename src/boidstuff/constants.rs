...
pub const COHERENCE: f32 = 0.020;
pub const SEPARATION: f32 = 0.085;
pub const ALIGNMENT: f32 = 0.35;
...
pub const MAX_RAND_CHANGE: f32 = 0.4;
pub const SIGHT_ANGLE : f32 = 0.6 * std::f32::consts::PI;
